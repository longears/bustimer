...
var BoardRow = React.createClass({
    ...
    render: function() {
        ...
        return (
            ...
            >
                <div className='busRowCell busRowRouteName'>{route}</div>
                <div className='busRowCell busRowRelativeTime'>{epochTimeToRelativeHumanMinutes(this.props.epochTime - this.props.walkTimeMs)} m</div>
                <div className='busRowCell busRowAbsoluteTime'>{epochTimeToTimeOfDay(this.props.epochTime - this.props.walkTimeMs)}</div>
            </div>
        );
    }
});
    ...
    render: function() {
        ...
        return (
            <div className='boardHeader'>
                {lastUpdatedDiv}
                <div className='boardTitle'>{this.props.stopName}</div>
                <div className='walkTimeGroup'>
                    <div className='walkTimeLabel'></div>
                    <a href="#"
    ...
    render: function() {
        ...
        return (
            <div className='boardContainer'>
                ...
                />
                <div className='busRowContainer'>{busRows}</div>
            </div>
        );
...
var BoardGroup = React.createClass({
    ...
    //      title
    render: function() {
        return <div className='boardGroup'>
            <div className='boardGroupTitle'>{this.props.title}</div>
            <div className='boardGroupContents'>{this.props.children}</div>
        </div>
    }
});
...
var OverallInterface = React.createClass({
    ...
    render: function() {
        return <div className='overallInterfaceChild'>
